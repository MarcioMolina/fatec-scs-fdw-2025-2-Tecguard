...
################################################################################
## Form generated from reading UI file 'Home_tabwidget_white_fhdvGwpWp.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet(u"background-color: #F8F8FF")
        ...
        self.tabHome.setStyleSheet(u"background-color:#F8F8FF;\n"
"color:black ;")
        ...
        self.label_Background.setGeometry(QRect(-540, -90, 2321, 1171))
        ...
        self.verticalLayoutWidget.setGeometry(QRect(-10, 40, 411, 851))
        ...
        self.label_ImgRede.setPixmap(QPixmap(u"images/interneticonepequeno (5).png"))
...
"background-color:darkorange")
        ...
        self.label_Alerta.setGeometry(QRect(430, 80, 311, 63))
        ...
        self.label_Alertanotif.setGeometry(QRect(430, 160, 201, 51))
        ...
        self.label_SetaDownload.setStyleSheet(u"color:black;")
        self.label_SetaDownload.setPixmap(QPixmap(u"images/imgsetacima2.png"))
        ...
        self.label_SetaUpload.setStyleSheet(u"color:black;")
        self.label_SetaUpload.setPixmap(QPixmap(u"images/imgsetabaixo3.png"))
        ...
        self.label_CriacaoACL.setStyleSheet(u"background-color: darkorange;\n"
"font-size: 25px;\n"
"color: black;")
        ...
        self.label_nomeACL.setStyleSheet(u"color: black;")
        ...
        self.label_comecoIP.setStyleSheet(u"color: black;")
        ...
        self.label_FinalIP.setStyleSheet(u"color: black;")
        ...
        self.label_Protocolo.setStyleSheet(u"color: black;")
        ...
        self.label_Direcao.setStyleSheet(u"color: black;")
        ...
        self.label_Acao.setStyleSheet(u"color: black;")
        ...
        self.lineEdit_nomeACL.setStyleSheet(u"color: black;")
        ...
        self.lineEdit_comecoIP.setStyleSheet(u"color: black;")
        ...
        self.lineEdit_FinalIP.setStyleSheet(u"color: black;")
        ...
        self.comboBox_protocolo.setStyleSheet(u"color: black;")
        ...
        self.comboBox_direcao.setStyleSheet(u"color: black;")
        ...
        self.comboBox_acao.setStyleSheet(u"color: black;")
        ...
        self.checkBox_SSH.setStyleSheet(u"color: black;")
        ...
        self.checkBox_Telnet.setStyleSheet(u"color: black;")
        ...
        self.checkBox_RPC.setStyleSheet(u"color: black;")
        ...
        self.label_outros.setStyleSheet(u"color: black;")
        ...
        self.checkBox_HTTP.setStyleSheet(u"color: black;")
        ...
        self.checkBox_DNS.setStyleSheet(u"color: black;")
        ...
        self.checkBox_FTP.setStyleSheet(u"color: black;")
        ...
        self.label_servicos.setStyleSheet(u"color: black;")
        ...
        self.lineEdit_outros.setStyleSheet(u"color: black;")
        ...
        self.checkBox_NetBIOS.setStyleSheet(u"color: black;")
        ...
        self.checkBox_iCMP.setStyleSheet(u"color: black;")
        ...
        self.checkBox_SNMP.setStyleSheet(u"color: black;")
...
"background-color: 	#FF8C00")
        ...
        __qtablewidgetitem17.setForeground(brush1);
        ...
        brush2 = QBrush(QColor(6, 6, 6, 255))
...
"color: white")
        ...
        self.pushButton_relatorio = QPushButton(self.layoutWidget)
...
"color: white")
        ...
        __qtablewidgetitem22.setForeground(brush1);
        ...
        __qtablewidgetitem23.setForeground(brush1);
        ...
        __qtablewidgetitem24.setForeground(brush1);
        ...
        __qtablewidgetitem25.setForeground(brush1);
        ...
        self.tableWidget_relatorio.setGeometry(QRect(-10, 0, 2051, 861))
        ...
        self.widget_configuracaodeIA_4 = QWidget(self.tab_5)
        self.widget_configuracaodeIA_4.setObjectName(u"widget_configuracaodeIA_4")
        self.widget_configuracaodeIA_4.setGeometry(QRect(90, 350, 331, 91))
        self.label_ConfiguracaodeIA = QLabel(self.widget_configuracaodeIA_4)
...
"font-size: 16px;")
        self.label_Tema_3 = QLabel(self.widget_configuracaodeIA_4)
        self.label_Tema_3.setObjectName(u"label_Tema_3")
        self.label_Tema_3.setGeometry(QRect(9, 35, 36, 21))
        self.label_Tema_3.setFont(font)
        self.label_Tema_3.setStyleSheet(u"")
        self.label_Tema_3.setFrameShape(QFrame.Shape.NoFrame)
        self.label_Tema_3.setFrameShadow(QFrame.Shadow.Plain)
        self.label_Tema_3.setLineWidth(1)
        self.label_Tema_3.setTextFormat(Qt.TextFormat.AutoText)
        self.label_Resolucao_3 = QLabel(self.widget_configuracaodeIA_4)
        self.label_Resolucao_3.setObjectName(u"label_Resolucao_3")
        self.label_Resolucao_3.setGeometry(QRect(9, 62, 71, 20))
        self.label_Resolucao_3.setFont(font)
        self.label_Resolucao_3.setStyleSheet(u"")
        self.label_Resolucao_3.setFrameShape(QFrame.Shape.NoFrame)
        self.label_Resolucao_3.setFrameShadow(QFrame.Shadow.Plain)
        self.label_Resolucao_3.setLineWidth(1)
        self.label_Resolucao_3.setTextFormat(Qt.TextFormat.AutoText)
        self.comboBox_Tema = QComboBox(self.widget_configuracaodeIA_4)
        ...
        self.comboBox_Resolucao = QComboBox(self.widget_configuracaodeIA_4)
        ...
        self.verticalWidget_ConfGeral_3.setGeometry(QRect(90, 480, 331, 231))
        self.verticalLayout_5 = QVBoxLayout(self.verticalWidget_ConfGeral_3)
        self.verticalLayout_5.setObjectName(u"verticalLayout_5")
        self.label_ConfLog = QLabel(self.verticalWidget_ConfGeral_3)
...
"font-size: 16px;")
        ...
        self.verticalLayout_5.addWidget(self.label_ConfLog)

        self.formWidget_3 = QWidget(self.verticalWidget_ConfGeral_3)
        self.formWidget_3.setObjectName(u"formWidget_3")
        self.formLayout_3 = QFormLayout(self.formWidget_3)
        self.formLayout_3.setObjectName(u"formLayout_3")
        self.comboBox_RetencaoLog = QComboBox(self.formWidget_3)
        ...
        self.formLayout_3.setWidget(0, QFormLayout.FieldRole, self.comboBox_RetencaoLog)

        self.label_RetencaoLog = QLabel(self.formWidget_3)
        self.label_RetencaoLog.setObjectName(u"label_RetencaoLog")
        self.label_RetencaoLog.setFont(font)

        self.formLayout_3.setWidget(0, QFormLayout.LabelRole, self.label_RetencaoLog)

        self.label_RetencaoOutros = QLabel(self.formWidget_3)
        ...
        self.formLayout_3.setWidget(1, QFormLayout.LabelRole, self.label_RetencaoOutros)

        self.lineEdit_RetencaoOutros = QLineEdit(self.formWidget_3)
        ...
        self.formLayout_3.setWidget(1, QFormLayout.FieldRole, self.lineEdit_RetencaoOutros)

        self.label_EnvioLogs = QLabel(self.formWidget_3)
        self.label_EnvioLogs.setObjectName(u"label_EnvioLogs")
        self.label_EnvioLogs.setFont(font)

        self.formLayout_3.setWidget(2, QFormLayout.LabelRole, self.label_EnvioLogs)

        self.radioButton_EnvioLogsSim = QRadioButton(self.formWidget_3)
        self.radioButton_EnvioLogsSim.setObjectName(u"radioButton_EnvioLogsSim")

        self.formLayout_3.setWidget(2, QFormLayout.FieldRole, self.radioButton_EnvioLogsSim)

        self.radioButton_EnvioLogsNo = QRadioButton(self.formWidget_3)
        self.radioButton_EnvioLogsNo.setObjectName(u"radioButton_EnvioLogsNo")

        self.formLayout_3.setWidget(3, QFormLayout.FieldRole, self.radioButton_EnvioLogsNo)

        self.lineEdit_IP = QLineEdit(self.formWidget_3)
        ...
        self.formLayout_3.setWidget(4, QFormLayout.FieldRole, self.lineEdit_IP)

        self.label_IP = QLabel(self.formWidget_3)
        self.label_IP.setObjectName(u"label_IP")
        self.label_IP.setFont(font)

        self.formLayout_3.setWidget(4, QFormLayout.LabelRole, self.label_IP)

        self.label_Porta = QLabel(self.formWidget_3)
        self.label_Porta.setObjectName(u"label_Porta")
        self.label_Porta.setFont(font)

        self.formLayout_3.setWidget(5, QFormLayout.LabelRole, self.label_Porta)

        self.lineEdit_Porta = QLineEdit(self.formWidget_3)
        ...
        self.formLayout_3.setWidget(5, QFormLayout.FieldRole, self.lineEdit_Porta)


        self.verticalLayout_5.addWidget(self.formWidget_3)

        self.verticalWidget_ConfGeral_4 = QWidget(self.tab_5)
        self.verticalWidget_ConfGeral_4.setObjectName(u"verticalWidget_ConfGeral_4")
        self.verticalWidget_ConfGeral_4.setGeometry(QRect(100, 70, 333, 231))
        self.verticalLayout_7 = QVBoxLayout(self.verticalWidget_ConfGeral_4)
        self.verticalLayout_7.setObjectName(u"verticalLayout_7")
        self.label_ConfGeral_6 = QLabel(self.verticalWidget_ConfGeral_4)
        self.label_ConfGeral_6.setObjectName(u"label_ConfGeral_6")
        self.label_ConfGeral_6.setFont(font2)
        self.label_ConfGeral_6.setStyleSheet(u"background-color: #FF8C00;\n"
"font-size: 16px;")

        self.verticalLayout_7.addWidget(self.label_ConfGeral_6)

        self.widget_Opcoesgeral_6 = QWidget(self.verticalWidget_ConfGeral_4)
        self.widget_Opcoesgeral_6.setObjectName(u"widget_Opcoesgeral_6")
        self.formLayout_8 = QFormLayout(self.widget_Opcoesgeral_6)
        self.formLayout_8.setObjectName(u"formLayout_8")
        self.label_MododeOperacao = QLabel(self.widget_Opcoesgeral_6)
        ...
        self.formLayout_8.setWidget(2, QFormLayout.LabelRole, self.label_MododeOperacao)

        self.comboBox_operacao = QComboBox(self.widget_Opcoesgeral_6)
        ...
        self.formLayout_8.setWidget(2, QFormLayout.FieldRole, self.comboBox_operacao)

        self.label_PerfisRede = QLabel(self.widget_Opcoesgeral_6)
        ...
        self.formLayout_8.setWidget(3, QFormLayout.LabelRole, self.label_PerfisRede)

        self.comboBox_PerfisRede = QComboBox(self.widget_Opcoesgeral_6)
        ...
        self.formLayout_8.setWidget(3, QFormLayout.FieldRole, self.comboBox_PerfisRede)

        self.label_FiltrodeInvasoes = QLabel(self.widget_Opcoesgeral_6)
        ...
        self.formLayout_8.setWidget(4, QFormLayout.LabelRole, self.label_FiltrodeInvasoes)

        self.comboBox_filtro = QComboBox(self.widget_Opcoesgeral_6)
        ...
        self.formLayout_8.setWidget(4, QFormLayout.FieldRole, self.comboBox_filtro)

        self.label_ModoGamer = QLabel(self.widget_Opcoesgeral_6)
        ...
        self.formLayout_8.setWidget(5, QFormLayout.LabelRole, self.label_ModoGamer)

        self.comboBox_ModoGamer = QComboBox(self.widget_Opcoesgeral_6)
        ...
        self.formLayout_8.setWidget(5, QFormLayout.FieldRole, self.comboBox_ModoGamer)

        self.label_PopupdeNotif = QLabel(self.widget_Opcoesgeral_6)
        ...
        self.formLayout_8.setWidget(6, QFormLayout.LabelRole, self.label_PopupdeNotif)

        self.comboBox_PopupdeNotif = QComboBox(self.widget_Opcoesgeral_6)
        ...
        self.formLayout_8.setWidget(6, QFormLayout.FieldRole, self.comboBox_PopupdeNotif)

        self.label_ModeloIA = QLabel(self.widget_Opcoesgeral_6)
        ...
        self.formLayout_8.setWidget(7, QFormLayout.LabelRole, self.label_ModeloIA)

        self.comboBox_ModeloIA = QComboBox(self.widget_Opcoesgeral_6)
        ...
        self.formLayout_8.setWidget(7, QFormLayout.FieldRole, self.comboBox_ModeloIA)


        self.verticalLayout_7.addWidget(self.widget_Opcoesgeral_6)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_Tema_3.setText(QCoreApplication.translate("MainWindow", u"Tema", None))
        self.label_Resolucao_3.setText(QCoreApplication.translate("MainWindow", u"Resolu\u00e7\u00e3o", None))
        ...
        self.label_ConfGeral_6.setText(QCoreApplication.translate("MainWindow", u"Configura\u00e7\u00e3o geral", None))
